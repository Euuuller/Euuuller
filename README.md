...
<div align="justify">
  <p style="text-indent: 2em;">
    Seja muito bem-vindo(a) ao meu perfil no GitHub! Aqui você encontrará uma coleção dos meus projetos e contribuições, refletindo minha paixão por Ciência de Dados e minha jornada em transformar dados em insights acionáveis.
     Neste template, demonstro minhas habilidades para resolver problemas de negócio utilizando conceitos e ferramentas de Análise de Dados e Ciência de Dados, através de projetos com dados públicos. Você encontrará também habilidades, ferramentas e conceitos envolvendo Análise e Ciência de Dados.
...
<div align="center">
  ...
  <a href="https://github.com/euuuller" target="_blank">
